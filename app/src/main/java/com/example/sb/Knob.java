...
public class Knob extends View {
    ...
    private int indicatorWidth = 50;
    private int indicatorColor = Color.parseColor("#F8B109");
    private float indicatorRelativeLength = 0.0f;
    private float circularIndicatorRelativeRadius = 0.09f;
    private float circularIndicatorRelativePosition = 0.6f;
    private int circularIndicatorColor = Color.parseColor("#F8B109");
    private int knobColor = Color.BLACK;
    private float knobRelativeRadius = 0.8f;
    private float knobCenterRelativeRadius = 0.45f;
    private int knobCenterColor = Color.BLACK;
    ...
    private int stateMarkersWidth = 50;
    private int stateMarkersColor = Color.BLACK;
    private int selectedStateMarkerColor = Color.WHITE;
    private boolean selectedStateMarkerContinuous = false;
    private float stateMarkersRelativeLength = 0.001f;
